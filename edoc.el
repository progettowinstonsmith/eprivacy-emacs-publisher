...
(defun edoc-save-current-edition ()
  "Salva l'edizione corrente come customization per future sessions."
  (interactive)
  (customize-save-variable 'edoc-current-edition-path edoc-current-edition-path)
  (message "Edizione di lavoro salvata: %s" edoc-current-edition-path))
